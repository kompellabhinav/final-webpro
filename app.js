...
const uri =
  "mongodb+srv://abhinavkompella502:abhi1289@cluster1.d4hjtfo.mongodb.net/?retryWrites=true&w=majority";
  ...
  User.findOne({ email: user_name })
    ...
    .then(function (data) {
      ...
      if (data.password == passwordEntered) {
        ...
        User.findOne({ email: emailEntered }).then(function (foundItems) {
